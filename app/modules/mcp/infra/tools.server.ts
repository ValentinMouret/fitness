...
export function registerFitnessTools(
  ...
  write(
    "update_workout_set",
    "Patch one existing set. updates.reportedRir is the lifter's post-set estimate: 0, 1, 2, 3, 4+, unsure, or null to clear. A report requires a completed working set. Omitted fields remain unchanged; historic RPE is separate and is never converted to RIR.",
    patchSetSchema,
    commands.updateSet,
    false,
    true,
