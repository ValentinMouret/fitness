...
export function FitbodImportForm({
  onImportSuccess,
  onCancel,
}: FitbodImportFormProps) {
  ...
  const handleSubmit = useCallback(
    async (event: React.FormEvent) => {
      ...
      try {
        ...
        formData.append("importSource", "fitbod");
        formData.append("csvContent", csvContent);
        formData.append(
          "createMissingExercises",
          String(createMissingExercises),
        );
    ...
    <Card size="4">
      <Flex direction="column" gap="4">
        <Flex justify="between" align="center">
          <Heading size="6">Import Workouts from Fitbod</Heading>
          {onCancel && (
        ...
        <Text size="2" color="gray">
          Upload your Fitbod CSV export file. The import will automatically map
            ...
            {hasSuccess && fetcher.data?.result && (
              <Callout.Root color="green">
                ...
                <Callout.Text>
                  ...
                  <Flex direction="column" gap="2">
                    <Text>Your workouts have been imported successfully.</Text>
