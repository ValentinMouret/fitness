...
- Inbox (for things to read, watch, write)
  ...
  - The agent should scout the Internet to find articles I might like and keep me up to date
- Charles had an interesting point to frame the product with LLMs at the center. Traditional software is build around this idea that you write code/data model to do stuff. Maybe today, an LLM assisted with traditional software can yield better products. For example, a model that can access structured data on me.
