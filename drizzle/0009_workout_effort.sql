alter table "workout_sets" add column "target_rir_min" integer;--> statement-breakpoint
alter table "workout_sets" add column "target_rir_max" integer;--> statement-breakpoint
alter table "workout_sets" add column "target_rir_source" text;--> statement-breakpoint
alter table "workout_sets" add column "reported_rir" text;--> statement-breakpoint
alter table "workout_sets" add constraint "target_rir_valid" check (("workout_sets"."target_rir_min" is null and "workout_sets"."target_rir_max" is null and "workout_sets"."target_rir_source" is null) or ("workout_sets"."target_rir_min" is not null and "workout_sets"."target_rir_max" is not null and "workout_sets"."target_rir_source" is not null and "workout_sets"."target_rir_min" between 0 and 4 and "workout_sets"."target_rir_max" between "workout_sets"."target_rir_min" and 4 and "workout_sets"."target_rir_source" in ('coach', 'plan')));--> statement-breakpoint
